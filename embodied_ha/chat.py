...
def _run_chat_turn(cfg, chat_source, user_msg, resident, timestamp,
    ...
    projected_camera_source = chat_context.resolve_projected_camera_entity(body_location_file, prefs_file)
    camera_history_enabled, camera_history_minutes = chat_invoke.read_camera_history_settings(prefs_file)
    ...
    prompt = chat_invoke.build_chat_prompt(
        ...
        camera_history_minutes=camera_history_minutes,
    )
