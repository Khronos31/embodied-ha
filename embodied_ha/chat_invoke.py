...
def build_message_envelope(prompt):
    """stream-json入力形式のユーザーメッセージ封筒を作る（chat.sh:512と同一）。"""
    return json.dumps({"type": "user", "message": {"role": "user", "content": [{"type": "text", "text": prompt}]}})
